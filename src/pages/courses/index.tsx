...
export function CourseListPage(props: CourseListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getCourses({
        relations: ['user', 'organization', 'attendance.count', 'student.count', 'zoom_meeting.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('student', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('zoom_meeting', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'zoom_meeting',
          header: 'Zoom Meeting',
          accessorKey: 'zoom_meeting',
          cell: ({ row: { original: record } }: any) => record?._count?.zoom_meeting,
        }
      : null,
