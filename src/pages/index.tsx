  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to gbi, your comprehensive solution for creating and managing your own college management system, tracking student attendance, and conducting classes through Zoom."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to gbi, your comprehensive solution for creating and managing your own college management system, tracking student attendance, and conducting classes through Zoom.`}
            </Text>
            <Box
